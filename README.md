...
- Onyx quick support now sleeps in the bubble and wakes into listening/support moods when opened.
- Expanded Onyx mood images are copied into assets/onyx-moods and mapped by filename.
